...
namespace AdventureGame.SpriteManagement
{
    ...
    public class SpriteControllerList : MonoBehaviour
    {
        ...
        [Header("Should the configurations be applied when the time range changes?")]
        public bool ApplyOnStartOnly;
        public SpriteControllerConfig[] configurations;

        private SpriteControllerConfig activeConfig = null;
        public SpriteControllerConfig ActiveConfig => activeConfig;
