...
namespace AdventureGame.SpriteController
{
    ...
    public class SpriteController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Returns the index of the currently active sprite in the sprites array.
        /// If no sprite is assigned or it is not found in the list, -1 is returned.
        /// </summary>
        public int GetCurrentSpriteIndex()
        {
            if (spriteRenderer == null || spriteRenderer.sprite == null || sprites == null)
                return -1;

            Sprite current = spriteRenderer.sprite;

            for (int i = 0; i < sprites.Length; i++)
                if (sprites[i] == current)
                    return i;
